...
public abstract class CollectionManager1<T> {
	 ...
	 * @param obj : model
	 */
	public void update(T obj, String findString, String value){
		Document newDoc = convertToDocument(obj);
		
		collection.updateOne(Filters.eq(findString, value),
